...
| GET | `/api/v1/after-sales/{id}/reship-logistics` | 换货发货物流 | reshipLogistics |
| GET | `/api/v1/after-sales/{id}/return-logistics` | 退货物流 | returnLogistics |
| POST | `/api/v1/after-sales/{id}/return-shipment` | 提交买家退货物流信息 | submitReturnShipment |
| POST | `/api/v1/auth/captcha` | 发送验证码 | captcha |
| POST | `/api/v1/auth/forgotPassword` | 忘记密码 | forgotPassword |
...
| GET | `/api/v1/group-buy/products/{activityId}/{spuId}` | 拼团商品详情 | show |
...
| DELETE | `/api/v1/member/addresses/{id}` | 删除收货地址 | destroy |
| GET | `/api/v1/member/addresses/{id}` | 收货地址详情 | show |
| PUT | `/api/v1/member/addresses/{id}` | 修改收货地址 | update |
| POST | `/api/v1/member/addresses/{id}/default` | 设为默认地址 | markDefault |
...
| POST | `/api/v1/member/phone/bind` | 绑定手机号 | bindPhone |
| GET | `/api/v1/member/profile` | 个人资料 | profile |
| POST | `/api/v1/member/profile/authorize` | 授权头像昵称 | authorizeProfile |
| POST | `/api/v1/member/profile/update` | 更新个人资料 | updateProfile |
...
| GET | `/api/v1/seckill/products/{sessionId}/{spuId}` | 秒杀商品详情 | show |
| GET | `/api/v1/seckill/sessions` | 秒杀场次列表 | index |
